...
void vpu_pipeline_set_rdma_count(int vpp_index)
{
	if (vpp_index < 3)
		vpp_rdma_count[vpp_index]++;
}

u64 vpu_pipeline_get_rdma_count(int vpp_index)
{
	return vpp_rdma_count[vpp_index];
}
